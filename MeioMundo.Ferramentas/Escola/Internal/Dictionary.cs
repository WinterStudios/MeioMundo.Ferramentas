...
namespace MeioMundo.Ferramentas.Escola.Internal
{
    ...
    public class AnosDictionary : INotifyPropertyChanged
    {
        ...
        private int id;
        public string Nome { get => nome; set { nome = value; NotifyPropertyChanged(); } }
        private string nome;
        public bool IsSelect { get => isSelect; set { isSelect = value; NotifyPropertyChanged(); } }
        private bool isSelect;
        public bool IsCiclo { get => isCiclo; set { isCiclo = value; NotifyPropertyChanged(); } }
        private bool isCiclo;
    }

    public class Disciplinas
    {
        public static Dictionary<int, string> GetDisciplinas()
        {
            Dictionary<int, string> keys = new Dictionary<int, string>();
    ...
    public class DisciplinasDictionary : INotifyPropertyChanged
    {
        #region Notification Changed
        public event PropertyChangedEventHandler PropertyChanged;
        private void NotifyPropertyChanged([CallerMemberName] String propertyName = "")
